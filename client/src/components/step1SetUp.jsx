        ...
        className="p-12 bg-white" >
          ...
          <div className='space-y-6'>
              ...
              <div className='relative'>
                <FaUserTie className= 'absolute top-4 left-4 text-gray-400'/>
                  ...
                  className='w-full pl-12 pr-4-4 py-3 border-gray-200 rounded-xl focus:ring-2 focus:ring-green500 outline-none transition'
          ...
          <select
                ...
                {analysisDone && (
                  ...
                  className='bb-gray-50 border border-gray-200 rounded-xl p-5 space-y-4'>
                     ...
                     {skills.length>0 && (
                      <div>
                        ...
                        <div className='list-disc list-inside text-gray-600 space-y-1'>
                          {skills.map((p,i)=>(
                            <span key={i} className='bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm' >{p}</span>
                          ))}
                        </div>
                      </div>
                    )}
