...
import {AreaChart, CartesianGrid, ResponsiveContainer, XAxis, YAxis, Tooltip, Area} from "recharts"
...
if (finalScore >= 8) {
  ...
  shortTagline = "Excellent clarity ...";
} else if (finalScore >= 5) {
  performanceText = "Needs minor i...";
  shortTagline = "Good foundation, ...";
} else {
  performanceText = "Significant ...";
  shortTagline = "Work on clarity ...";
}
...
if (finalScore >= 8) {
  advice =
    "Excellent performance. Maintain confidence and structure. Continue enhancing clarity and supporting answers with strong real-world examples.";
} else if (finalScore >= 5) {
  advice =
...
return (
    ...
    <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                  ...
                  <button 
                  onClick={downloadPDF}
                  className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base'>Download PDF</button>
    </div>
