...
import { BsRobot,BsMic,BsClock,BsBarChart,BsFileEarmarkText,BsGraphUp } from "react-icons/bs";
import { useNavigate } from 'react-router-dom'
import AuthModel from '../components/AuthModel'
import evalImg from "../assets/ai-ans.png"
import resumeImg from "../assets/img1.png";
import pdfImg from "../assets/pdf.png";
import analyticsImg from "../assets/history.png";
import hrImg from "../assets/HR.png";
import techImg from "../assets/MM.png";
        ...
        <div className='flex-1 px-6 py-20'>
          ...
          <div className='flex justify-center mb-6'>
            ...
            onClick={()=>{
              ...
              whileHover = {{opacity:0.9,scale:1.03}}
              whileTap = {{opacity:1,scale:0.98}}
              className='bg-white text-black px-10 py-3 rounded-full hover:opacity-90 transition '>
                view History
            </motion.button>
            </div>
          </div>
            ...
            <div className = 'flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
              ...
              className={
                `relative bg-white rounded-3xl border border-2 border-green-100
              ...
              `}>
                    ...
                    <div className = 'absolute -top-4 left-1/2 -translate-x-1/2 bg-white border border-green-500 text-green-600 w-16 rounded-2xl flex items-center justify-center shadow-lg'>
                        {item.icon}
                    </div>
            ...
            [
              ...
              className = 'bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                <div className='flex flex-col md:flex-row items-center gap-8'>
                  ...
                  <div className = 'bg-green-50 text-green-600 w-12 rounded-xl flex items-center justify-center mb-6'>
                    {item.icon}
                  </div>
